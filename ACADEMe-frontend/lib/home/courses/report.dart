...
class TestReportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Test Report", style: GoogleFonts.poppins(fontSize: 22, fontWeight: FontWeight.normal, color: Colors.white)),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("Overall Score", style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w500, color: Colors.white)),
            SizedBox(height: 8),
            Row(
      ...
      child: BarChart(
        BarChartData(
          ...
          titlesData: FlTitlesData(
            bottomTitles: AxisTitles(sideTitles: _bottomTitles(["LCM", "HCF","Geometry", "Graphs", "Algebra"])),
