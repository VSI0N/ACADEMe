          ...
          children: [
            ...
            ListView(
              ...
              children: [
                GestureDetector(
                  onTap: () async {
                    final selected = await showClassSelectionSheet(context); // Capture returned value
                    if (selected != null) {
                      _updateClass(selected); // Call update function
                    }
                  },
...
Future<String?> showClassSelectionSheet(BuildContext context) async {
  return showModalBottomSheet<String>(
    ...
    builder: (BuildContext context) {
      final classes = List.generate(12, (index) => 'Class ${index + 1}');
      String? selectedClass; // Track selected class

      return StatefulBuilder(
        builder: (context, setState) {
          return Container(
            height: MediaQuery.of(context).size.height * 0.55, // Slightly increased height
            ...
            child: Column(
              children: [
                ...
                // Continue Button if class selected
                if (selectedClass != null)
                  ElevatedButton(
                    onPressed: () {
                      Navigator.pop(context, selectedClass); // Return selected class
                    },
                    child: Text('Continue',
                      style: TextStyle(
                          color: Colors.black
